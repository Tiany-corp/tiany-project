        ...
        <main className="min-h-screen bg-bgPrimary text-textPrimary px-6 md:px-16 py-20 flex flex-col items-center">
            ...
            >
                ...
                <div className="text-textSecondary text-lg leading-relaxed max-w-3xl mx-auto flex flex-col gap-4 text-center">
                    <p>
                        À l’heure où l’IA commence à redéfinir le marché du travail, je prends l’initiative de l’utiliser pour concevoir des projets qui nous rendent plus intentionnels, plus focus et plus alignés avec nos valeurs. C’est cette vision que j’applique concrètement, notamment à travers le développement de mon application de gestion de pensées et d’autres outils conçus pour booster notre progression.
                    </p>
                    <p>
                        Piloter ce genre d’écosystèmes est précisément ce qui m’anime dans le métier de Chef de Projet IA. Pour incarner cette ambition et accélérer des innovations à impact, je recherche activement une alternance pour la rentrée 2026.
                    </p>
                </div>
            </motion.section>
